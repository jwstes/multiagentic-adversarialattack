# elastic_net_attack.py
#
# Wrapper for ART's ElasticNet attack.
# This attack optimizes a loss function with a mixed L1 and L2 penalty.
#
# See: https://adversarial-robustness-toolbox.readthedocs.io/en/latest/modules/attacks/evasion.html#elastic-net-attack
# ---------------------------------------------------------------------
...
def elastic_net_attack(
    ...
    # ---- ART ElasticNet hyper-parameters ----
    ...
    """
    Run ART's ElasticNet attack on a single image.
    ...
    binary_search_steps : Number of steps for binary search of the constant c.
    max_iter            : Maximum number of iterations.
    beta                : Hyperparameter balancing L1 and L2 norms.
    ...
    if n_classes is None:
        raise ValueError("`n_classes` must be provided for the ElasticNet wrapper.")
    ...
    print("Generating adversarial example with Elastic Net Attack...")
