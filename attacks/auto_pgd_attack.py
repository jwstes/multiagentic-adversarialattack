# auto_pgd_attack.py
#
# Wrapper for ART's AutoProjectedGradientDescent.
# This is a more robust version of the standard PGD attack.
#
# See: https://adversarial-robustness-toolbox.readthedocs.io/en/latest/modules/attacks/evasion.html#auto-projected-gradient-descent-apgd
# ---------------------------------------------------------------------
...
def auto_pgd_attack(
    ...
    # ---- ART AutoProjectedGradientDescent hyper-parameters ----
    norm: Union[int, float, str] = np.inf,
    eps: float = 8.0 / 255.0,
    eps_step: float = 1.0 / 255.0,
    max_iter: int = 100,
    batch_size: int = 1,
    verbose: bool = True,
    # ----------------------------------------------------------------
    ...
    """
    Run ART's AutoProjectedGradientDescent on a single image.
    ...
    if n_classes is None:
        raise ValueError("`n_classes` must be provided for the Auto-PGD wrapper.")
    ...
    print("Generating adversarial example with Auto-PGD...")
