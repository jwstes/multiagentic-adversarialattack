# auto_cg_attack.py
#
# Wrapper for ART's AutoConjugateGradient attack.
#
# See: https://adversarial-robustness-toolbox.readthedocs.io/en/latest/modules/attacks/evasion.html#autoconjugategradient-acg
# ---------------------------------------------------------------------
...
def auto_cg_attack(
    ...
    # ---- ART AutoConjugateGradient hyper-parameters ----
    ...
    """
    Run ART's AutoConjugateGradient attack on a single image.
    ...
    nb_random_init : Number of random initializations.
    ...
    if n_classes is None:
        raise ValueError("`n_classes` must be provided for the Auto-CG wrapper.")
    ...
    print("Generating adversarial example with Auto Conjugate Gradient Attack...")
